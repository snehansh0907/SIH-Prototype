...
export const AreaHotspotView: React.FC = () => {
  ...
  const voiceText =
    language === 'mr'
      ...
      : language === 'hi'
      ? `${activeDataset.nameMr || activeDataset.name} (${activeDataset.districtMr || activeDataset.district}) क्षेत्र में ${
          activeDataset.status === 'high'
            ? 'गंभीर'
            : activeDataset.status === 'moderate'
            ? 'मध्यम'
            : 'कम'
        } बीमारी गतिविधि दर्ज की गई है। ५ किमी के दायरे में ${activeDataset.activeCasesCount} खेतों में यह बीमारी पाई गई है। कृषि विज्ञान केंद्र की सलाह सुनें।`
      : `${
